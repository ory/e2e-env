...
# Contribute to Ory e2e-env<!-- omit in toc -->
...
_Please note_: We take Ory e2e-env's security and our users' trust very
seriously. If you believe you have found a security issue in Ory e2e-env,
...
e2e-env's direction. A great way to
do this is via
[Ory e2e-env Discussions](https://github.com/orgs/ory/discussions)
or the [Ory Chat](https://www.ory.sh/chat).

## FAQ

- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/ory/e2e-env/blob/master/CODE_OF_CONDUCT.md)

- I have a question. Where can I get
  [answers to questions regarding Ory e2e-env?](#communication)
...
- I want to talk to other Ory e2e-env users.
  [How can I become a part of the community?](#communication)

- I would like to know what I am agreeing to when I contribute to Ory
  e2e-env.
  Does Ory have
  [a Contributors License Agreement?](https://cla-assistant.io/ory/e2e-env)

- I would like updates about new versions of Ory e2e-env.
...
[list of good first issues](https://github.com/ory/e2e-env/labels/good%20first%20issue).

There are many other ways you can contribute. Here are a few things you can do
to help out:

- **Give us a star.** It may not seem like much, but it really makes a
  difference. This is something that everyone can do to help out Ory e2e-env.
...
- **Help with open issues.** We have a lot of open issues for Ory e2e-env and
...
Check out [Ory e2e-env Discussions](https://github.com/orgs/ory/discussions). This is a great place for
...
If you want to receive regular notifications about updates to Ory e2e-env,
...
before getting started to ensure your work is consistent with Ory e2e-env's
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/e2e-env/blob/master/.github/workflows/conventional_commits.yml)
...
[Contributor License Agreement](https://cla-assistant.io/ory/e2e-env).
...
git clone git@github.com:ory/ory/e2e-env.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/ory/e2e-env.git
